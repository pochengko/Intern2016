  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <section class="col-lg-7 connectedSortable">
        ...
        <?php echo form_open('/admin/about/create') ?>
        <form class="form-horizontal" role="form">
          <div class="form-group">
            <label for="aboutTitle" class="col-sm-2 control-label">Title</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="aboutTitle" placeholder="請輸入標題" required />
            </div>
          </div>
          <div class="form-group">
            <label for="aboutText" class="col-sm-2 control-label">Text</label>
            <div class="col-sm-10">
              <textarea name="aboutText" required >請輸入內文</textarea>
              <script>
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" class="btn btn-primary" name="submit" />Create about item</button>
            </div>
          </div>
        </form>
