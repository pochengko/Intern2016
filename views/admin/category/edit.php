  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <section class="col-lg-7 connectedSortable">
        ...
        <?php echo form_open('admin/category/edit');?>
        <form class="form-horizontal" role="form">
          <div class="form-group">
            <label for="classID" class="col-sm-2 control-label">ID</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="classID" value="<?php echo $category_item['classID']; ?>" readonly />
            </div>
          </div>
          <div class="form-group">
            <label for="className" class="col-sm-2 control-label">Name</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="className" placeholder="<?php echo $category_item['className']; ?>" required/>
            </div>
          </div>
          <div class="form-group">
